...
#' Output files: VN555_cslccd_bCCCred.RData
#'
...
nn_data$time <-  NA
save.image(file = "./Reconciliation/ETSlev/cslcc_555_bCCCred_preosqp.RData")
problem <- c()
...
save(DFcslcc, time_cslev, nn_data_cslev, 
     file="./Reconciliation/ETSlev/VN555_cslccd_bCCCred.RData")
