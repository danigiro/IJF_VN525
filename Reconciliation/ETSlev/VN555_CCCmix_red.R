...
#' VN555_CCCmix_red.R
#'
#' Averaging LCC using the bts base forecasts from both models (SA and ETS)
#'
...
#'
#' Input files: VN555_cslccd_bCCCred.RData VN555_cslccd_mean_red.RData
#'              VN555_base.RData
#' Output files: VN555_CCCmix_red.RData
#'
...
DFmix <- DF
save(DFmix, 
     file="./Reconciliation/ETSlev/VN555_CCCmix_red.RData")
